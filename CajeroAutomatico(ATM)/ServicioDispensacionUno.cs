...
{
    class ServicioDispensacionUno:IDispensacion
    {
        MenuPrincipal principal;
        public ServicioDispensacionUno()
        {
        ...
        public string messages(int messageType)
        {
            ...
            switch (messageType)
            {
                case 1:
                    ...
                    message = "El valor ingresado tiene que ser mayor o igual 200";
                    break;
